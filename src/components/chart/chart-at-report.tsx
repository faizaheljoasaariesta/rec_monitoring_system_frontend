...
import { getATFocusAnalytic } from "@/services/api/reports/at-reports";
import { SingleComboBox } from "@/components/combo-box/single-combo-box";
...
const ChartATReport: React.FC<ChartProps> = ({
  chartConfig = {},
}) => {
