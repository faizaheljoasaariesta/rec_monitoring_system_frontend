...
import { getDCFocusAnalytic } from "@/services/api/reports/dc-reports";
...
const ChartDCReport: React.FC<ChartProps> = ({
  chartConfig = {},
}) => {
  ...
  React.useEffect(() => {
    const fetchInitial = async () => {
      ...
      try {
        const res = await getDCFocusAnalytic(interval);
  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        <CardTitle>Analytic Digital Camera Report</CardTitle>
        <CardDescription>
                ...
                onClick={() => {
                  try {
                    ...
                    exportChartMachinePDF(chartData || [], chartRef.current, {
                      title: `Analytic Auto Trimming Report: AT IOT`,
                      interval,
                      dataType: `AT IOT`,
                    })
                ...
                onClick={() => {
                  try {
                    exportChartMachineExcel(chartData || [], {
                      title: `Analytic Digital Camera Report: DC IOT`,
                      interval,
                      dataType: `DC IOT`,
                    })
